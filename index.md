...
| 2026.07 - 2026.12 | **카카오 브레인** | 리서치 인턴 | 한국어 특화 LLM 파인튜닝 및 성능 평가 |
...
### 2. [광운 도우미 (KW-DreamPath)](https://github.com/minmin-min/KW-DreamPath/tree/main)
![광운 도우미 1](./kw_chatbot_2.png)
...
## 주요 논문
- 논문 제목: *"한국어 텍스트 특성을 반영한 RAG 임베딩 기법의 검색 정확도 향상에 관한 연구"* (2027.06)
- 역할: 데이터 샘플링 최적화 및 평가 모듈 설계
